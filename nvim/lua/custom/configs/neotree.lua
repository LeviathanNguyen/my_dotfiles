...
neo_tree.setup {
    ...
    -- Onlt sources listed here will be loaded.
    ...
    -- This is needed if you use expanders because the render in the indent.
    log_level = "info", -- "trace", "debug", "info", "warn", "error", "fatal"
    log_to_file = false, -- true, false, "path/to/file.log", use :NeoTreeLogs to show the files.
    ...
    --                           -- NOTE: this will speed up to 50ms for 1 second following a resize
    sort_case_insensitive = false, -- Used when sorting files and directories in the tree
    sort_function = nil, -- Use a custom function for sorting files and directories in the tree
    use_popups_for_input = true, -- If false, input will use vim.ui.input() instead of custom floats.
    ...
    default_component_configs = {
        ...
        name = {
            ...
            highlight_opened_files = false, -- Required `enable_opened_markers = true`.
    ...
    window = { -- see https://github.com/MunifTanjim/nui.nvim/tree/main/lua/nui/popup for
        ...
        auto_expand_width = false, -- expand the window when file exceeds the window width. Doesn't work with position = "float"
    ...
    filesystem = {
        ...
        async_directory_scan = "auto", -- "auto"   means refreshes are sync, but it's synchronous when called from the Neotree commands.
        ...
        cwd_target = {
            sidebar = "tab", -- sidebar is when position = left | right.
        ...
        --                               -- `true` will change the filter into full path
        ...
        --     -- but no one ever want to see .git files
        ...
        --     if string.len(search_term) < 4 and path == "$HOME" then
        --         table.insert(args, "--exclude")
