...
neo_tree.setup {
    ...
    window = {
        ...
        mappings = {
            ...
            ["P"] = { "toggle_preview", config = { use_float = true, use_image_image = true } },
    ...
    filesystem = {
        ...
        follow_current_file = {
            enabled = false, -- This will find and focus the file in the active buffer everytime the current file is changed while the tree is open
